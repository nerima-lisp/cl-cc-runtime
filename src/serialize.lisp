;;;; serialize.lisp — Wire-format tags/context and the serialization (write)
;;;; path, ending in SERIALIZE. The deserialization (read) path is in
;;;; deserialize.lisp, which loads after it.

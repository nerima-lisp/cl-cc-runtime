;;;; tests/image-tests.lisp — Coverage for src/image.lisp and src/image-restore.lisp
;;;;
...
;;;; covered by runtime-stdlib-3-image-tests.lisp; this file targets the binary
;;;; runtime-image path.)

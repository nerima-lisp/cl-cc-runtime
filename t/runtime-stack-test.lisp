...
(describe "segmented native stack" (it "maps 8KB and grows only when the downward stack pointer crosses its limit" (let ((cl-cc/runtime::*stack-segment-pool* nil)) (let* ((root (cl-cc/runtime::stack-segment-note-frame nil 8192)) (next (cl-cc/runtime::stack-segment-note-frame root 64))) (expect (cl-cc/runtime::stack-segment-size root) :to-be 8192) (expect (> (cl-cc/runtime::stack-segment-base root) 0) :to-be-truthy) (expect (cl-cc/runtime::stack-segment-prev next) :to-be root) (expect (cl-cc/runtime::stack-segment-release-frame next 64) :to-be root) (expect (cl-cc/runtime::stack-segment-used next) :to-be 0) (expect (cl-cc/runtime::stack-segment-next next) :to-be-null)))) (it "maps an oversize frame safely and resets pooled linkage" (let ((cl-cc/runtime::*stack-segment-pool* nil)) (let* ((root (cl-cc/runtime::stack-segment-note-frame nil 64)) (large (cl-cc/runtime::stack-segment-note-frame root 9000))) (expect (>= (cl-cc/runtime::stack-segment-size large) 9000) :to-be-truthy) (cl-cc/runtime::stack-segment-release-frame large 9000) (let ((reused (cl-cc/runtime::stack-segment-note-frame root 64))) (expect reused :to-be large) (expect (cl-cc/runtime::stack-segment-prev reused) :to-be root) (expect (cl-cc/runtime::stack-segment-next reused) :to-be-null) (expect (cl-cc/runtime::stack-segment-used reused) :to-be 64))))))
